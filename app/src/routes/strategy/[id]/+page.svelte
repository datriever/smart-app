<script lang="ts">
  import { tableThemes, textThemes } from '$lib/renderer';
	import Markdown, { type Theme } from '$lib/renderer/Markdown.svelte';
  ...
  const theme: Theme = {
    ...
    plot: {
      ...
      font: { color: "#d4f0e4" },
      fillParent: mobile ? 'width' : undefined
    }
  }
...
<main>
  <Markdown markdown={data.markdown} {theme}  />
</main>
